...
def Solution(n):
    ...
    BASE_TEN = 10
    reversed = 0  # the reversed number(building from 0)
    digits = int(math.log10(abs(n))) + 1  # the number of digits

    is_negative = n < 0  # whether or not the number is negative
    n = abs(n)  # take the positive value of the number
